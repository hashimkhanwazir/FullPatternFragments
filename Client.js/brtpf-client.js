...
var exports = module.exports = {
  SparqlIterator: require('./lib-brtpf/sparql/SparqlIterator.js'),
  FragmentsClient: require('./lib-brtpf/triple-pattern-fragments/federated/FederatedFragmentsClient'),
  Logger: require('./lib-brtpf/util/Logger'),
  HttpClient: require('./lib-brtpf/util/HttpClient'),
  SparqlResultWriter: function () {
    var SparqlResultWriter = require('./lib-brtpf/writers/SparqlResultWriter');
