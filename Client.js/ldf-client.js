...
var exports = module.exports = {
  SparqlIterator: require('./lib-tpf/sparql/SparqlIterator.js'),
  FragmentsClient: require('./lib-tpf/triple-pattern-fragments/federated/FederatedFragmentsClient'),
  Logger: require('./lib-tpf/util/Logger'),
  HttpClient: require('./lib-tpf/util/HttpClient'),
  SparqlResultWriter: function () {
    var SparqlResultWriter = require('./lib-tpf/writers/SparqlResultWriter');
